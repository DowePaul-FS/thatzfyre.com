                        ...
                        return (
                            <div class="item">
                                <div class="product product-grid">
                                    <div class="product-img-wrap"><img src={c.image1} alt="" width="300" height="300" />
                                    </div>
                                    <div class="product-caption">
                                        <ul class="product-categories">
                                            <ProdCat />
                                        </ul>
                                        <h6 class="product-title"><Link to={"/singleproduct/" + c.id} key={c.id}>{c.name}</Link></h6>
                                        <p class="product-price"><span>{c.price}</span>
