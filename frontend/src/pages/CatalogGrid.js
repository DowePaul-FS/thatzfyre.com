            ...
            <section class="breadcrumbs-custom">
                <div class="container">
                    <div class="breadcrumbs-custom__inner">
                        <p class="breadcrumbs-custom__title">Shop Grid</p>
                        ...
                        <div class="col-lg-9 section-divided__main section-divided__main-left">
                            <div class="section-sm">
                                ...
                                <div class="row justify-content-sm-center row-70">
                                    ...
                                    <div class="col-md-6 col-xl-4">
                                        <div class="product product-grid">
                                            <div class="product-img-wrap"><img src="assets/images/italian-furniture-contemporary-allumen-fixed-or-extendable-glass-top-table-by-sedit-2-300x300.jpg" alt="" width="300" height="300" />
                                                <div class="product-icon-wrap"><span class="icon icon-md linear-icon-heart" data-toggle="tooltip" data-original-title="Add to Wishlist"></span><span class="icon icon-md linear-icon-balance" data-toggle="tooltip" data-original-title="Add to Compare"></span></div>
                                            ...
                                            <div class="product-caption">
                                                ...
                                                <h6 class="product-title"><a href="single-product.html">Italian furniture contemporary allumen GLASS TABLE</a></h6>
                                                <p class="product-price sale-price"><span>45</span><span>56</span>
                                                </p><a class="button-black button button-icon button-icon-left" href="single-product.html"><span class="icon icon-md linear-icon-cart"></span><span>Add to cart</span></a>
                                                <ul class="rating-list">
                                                    <li><span class="icon linear-icon-star icon-secondary-4"></span></li>
                                                    <li><span class="icon linear-icon-star icon-secondary-4"></span></li>
                                    ...
                                    <div class="col-md-6 col-xl-4">
                                        <div class="product product-grid">
                                            <div class="product-img-wrap"><img src="assets/images/italian-furniture-contemporary-mix-steel-base-wooden-table-top-dining-table-by-sedit-2-300x300.jpg" alt="" width="300" height="300" />
                                                <div class="product-icon-wrap"><span class="icon icon-md linear-icon-heart" data-toggle="tooltip" data-original-title="Add to Wishlist"></span><span class="icon icon-md linear-icon-balance" data-toggle="tooltip" data-original-title="Add to Compare"></span></div>
                                            ...
                                            <div class="product-caption">
                                                ...
                                                <h6 class="product-title"><a href="single-product.html">Italian furniture contemporary mix steel base WOODEN SET</a></h6>
                                    ...
                                    <div class="col-md-6 col-xl-4">
                                        <div class="product product-grid">
                                            ...
                                            <div class="product-caption">
                                                ...
                                                <h6 class="product-title"><a href="single-product.html">My italian living contemporary manila leather BLUE CHAIR</a></h6>
